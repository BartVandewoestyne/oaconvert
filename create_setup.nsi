...
Section -Post
  ...
  WriteRegStr "HKLM" "Software\Garmin\Mapsource\Products\1" "BMAP" "$INSTDIR\garmin\MyFileName.img"
  WriteRegStr "HKLM" "Software\Garmin\Mapsource\Products\1" "TDB" "$INSTDIR\garmin\MyFileName.tdb"
  WriteRegStr "HKLM" "Software\Garmin\Mapsource\Products\1" "TYP" "$INSTDIR\garmin\1007B.TYP"
